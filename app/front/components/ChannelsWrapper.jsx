        ...
        <div className="flex-vertical flex-spacer">
          ...
          <div className="scroller-wrap fade dark">
            <div className="scroller guild-channels">
              ...
              <div className="channel channel-text" draggable="true"><a draggable="false" className="" href="/channels/110838748563914752/163674317207502849"><span className="channel-name">welcome</span>
              </a></div>
              ...
              <div className="channel channel-text" draggable="true"><a draggable="false" className="" href="/channels/110838748563914752/110866639448182784"><span className="channel-name">videos</span>
              </a></div>
              ...
              <div className="channel channel-text" draggable="true"><a draggable="false" className="" href="/channels/110838748563914752/128431661195984896"><span className="channel-name">liens</span>
              </a></div>
